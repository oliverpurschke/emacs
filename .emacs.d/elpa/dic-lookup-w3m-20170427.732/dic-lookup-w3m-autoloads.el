...

;;;### (autoloads nil "dic-lookup-w3m" "dic-lookup-w3m.el" (0 0 0
;;;;;;  0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dic-lookup-w3m" '("dic-lookup-w3m-")))

;;;***

;;;### (autoloads nil "dic-lookup-w3m-ja" "dic-lookup-w3m-ja.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from dic-lookup-w3m-ja.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dic-lookup-w3m-ja" '("dic-lookup-w3m-")))

;;;***

;;;### (autoloads nil "dic-lookup-w3m-text-translator" "dic-lookup-w3m-text-translator.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from dic-lookup-w3m-text-translator.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dic-lookup-w3m-text-translator" '("dic-lookup-w3m-")))

;;;***

;;;### (autoloads nil "dic-lookup-w3m-zh" "dic-lookup-w3m-zh.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from dic-lookup-w3m-zh.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dic-lookup-w3m-zh" '("dic-lookup-w3m-")))

;;;***

;;;### (autoloads nil nil ("dic-lookup-w3m-pkg.el") (0 0 0 0))
